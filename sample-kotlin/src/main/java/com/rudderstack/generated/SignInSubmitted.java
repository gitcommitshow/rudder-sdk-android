...
public final class SignInSubmitted extends SerializableProperties {
    private RudderProperty properties;

    private SignInSubmitted(RudderProperty properties) {
    ...
    /**
     * Builder for {@link SignInSubmitted}
     */
    public static class Builder {
        ...
        /**
         * The user's ID.
         * This property is required to generate a valid SignInSubmitted object
         */
         ...
         * This property is optional and not required to generate a valid SignInSubmitted object
         */
        ...
        /**
         * Build an instance of {@link SignInSubmitted}
         */
        public SignInSubmitted build() {
            if(properties.getProperty("id") == null){
                throw new IllegalArgumentException("SignInSubmitted missing required property: id");
            }
            return new SignInSubmitted(properties);
        }
    }
}
